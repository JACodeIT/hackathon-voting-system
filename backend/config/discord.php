...
return [
    ...
    */
    ...
    'access_token' => env('DISCORD_ACCESS_TOKEN', null),
    ...
    */
    ...
    'redirect_uri' => env('APP_URL', 'http://localhost:8000') . '/' . env('DISCORD_PREFIX', 'discord') . 'discord/callback',
    ...
    */
    ...
    'scopes' => env('DISCORD_SCOPE', 'identify&email'),
